...
<a target="_blank" href="<?php if ($row['link'] == '#') { echo 'no reference';} else { echo $row['link']; }?>" data-toggle="tooltip" title="<?php if ($row['link'] == '#') { echo 'no reference';} else { echo $row['link']; }?>"
                                        class="btn btn-default btn-medium <?php if ($row['link'] == '#') { echo 'disabled';}?>">Reference</a>
                                ...
                                <table>
                                    <tbody>
                                        <tr id="configField" name="configField" style="height:300px" value="">
												<?php echo '<td style="text-align:center;">'.$config.'</td>'; ?>
                                        </tr>
                                    </tbody>
                                </table>
